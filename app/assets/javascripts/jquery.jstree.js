		...
		_fn : { 
			...
			open_node	: function (obj, callback, skip_animation) {
				...
				if(!this._is_loaded(obj)) {
					...
					if(s) { obj.children("ul").stop(true, true).slideDown(s, function () { 
						this.style.display = ""; obj.children("ul").addClass('children ui-sortable'); t.after_open(obj);
						obj.children("ul").attr("data-sortable-type", "child");
					 }); }
